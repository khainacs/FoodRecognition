...
import com.plcoding.cameraApp.ui.theme.CameraXGuideTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            CameraXGuideTheme {
                ...
                val viewModelImage = viewModel<FileViewModel>()
                BottomSheetScaffold(
                        ...
                        Row(
                            ...
                            IconButton(
                                onClick = {
                                    ...
                                    viewModelImage.uploadImage(imageGlobal)
                                }
                            ) {
                                Icon(
    ...
    fun uploadImage(image: Bitmap?) {
        ...
        // Chuyển đổi Bitmap thành ByteArray
        ...
        val request = Request.Builder().url("https://192.168.1.6:9191/image").post(multipartBody).build()
